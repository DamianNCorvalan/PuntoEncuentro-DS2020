    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "342868556939096",
               appSecret: "537403af3c72b2196094238b81eefc6a");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "348386444335-tesbejp1ticu3pqhvpjca35tdp952nht.apps.googleusercontent.com",
                ClientSecret = "jsBcDRIjYzuqnQE9J6qZO7JR"
            });
        }
    }
}